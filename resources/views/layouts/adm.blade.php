...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-gradient-dark" id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link text-white " href="{{route('adm.users.index')}}">
            ...
            <li class="nav-item">
                <a class="nav-link text-white " href="{{route('adm.category.index')}}">
    ...
    <div class="sidenav-footer position-absolute w-100 bottom-0 ">
        <div class="mx-3">
            <a class="btn bg-bg-danger mt-4 w-100" href="https://www.creative-tim.com/product/material-dashboard-pro?ref=sidebarfree" type="button">Upgrade to pro</a>
        </div>
...
<main class="main-content border-radius-lg ">
        ...
        <div class="container-fluid py-1 px-3">
            <nav aria-label="breadcrumb">
                ...
                <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                    <li class="breadcrumb-item text-sm"><a class="opacity-5 text-dark" href="{{ route('products.index') }}">Pages</a></li>
    ...
    <!-- Control Center for Material Dashboard: parallax effects, scripts for the example pages etc --><script src="{{asset('/js/material-dashboard.min.js?v=3.0.4')}}"></script>
</body>
